  ...
  return (
    <section className={styles.home}>
      <div className={styles.logo}>
        <img className={styles.logoImage} src={oliveImage} alt="Olive Logo" style={{ width: '52px', height: '50.75247573852539px', transform: 'rotate(0deg)', opacity: 1 }} />
        <span className={styles.logoTitle}>OliveCareAI</span>
      </div>
      {/* About Us Buttons */}
      <div className={styles.aboutUsButtons}>
        <button className={styles.aboutButton}>About Us 1</button>
        <button className={styles.aboutButton}>About Us 2</button>
        <button className={styles.aboutButton}>About Us 3</button>
      </div>
